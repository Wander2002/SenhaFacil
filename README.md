...
- Localização da rede (opcional, mas útil para identificação automática).
...
Garantir que as senhas não sejam exibidas diretamente para os usuários (mostrar apenas status de conexão).
